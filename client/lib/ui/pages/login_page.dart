...
class _LoginPageState extends State<LoginPage> {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('특별한 순간의 감동을 다시 느껴보세요', style: TextStyle(color: textLightColor, fontSize: 14)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isLoading
                        ...
                        : const Text('기록 꺼내보기', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: 1.5)),
                  ),
                ),
                ...
                const Row(
                  children: [
                    Expanded(child: Divider(thickness: 1, color: Color(0xFFD6D1C4))),
                    Padding(padding: EdgeInsets.symmetric(horizontal: 10), child: Text('간편하게 열기', style: TextStyle(color: textLightColor, fontSize: 12))),
                    Expanded(child: Divider(thickness: 1, color: Color(0xFFD6D1C4))),
                  ],
                ),
                const SizedBox(height: 20),
  ...
  Widget _buildSocialButton({required Color color, required Color textColor, required IconData icon, Color? iconColor, required String text, bool isBordered = false, required VoidCallback onPressed}) {
    return SizedBox(
